...
//1> humne ek real life car ko declare karne k liye ek class banayi car

//3> abhi humko bus gaadi k methods pta hone chaiye bus startEngine(),shiftGear(int gear) etc gaddi chalane k liye inko use karke gaddi chala sakte hai joki ye ek interface ka kaam kar rhi hai 

// In short abhi ek gaadi hai jisme humne virtual fn banaye and usme ye methods interface ka kaam karte hai jis ki vajah se hum gaadi chala sakte hai 

class Car {
public:
    virtual void startEngine() = 0; //2> virtual bus ye batata hai ki yeh joh method hai na hum usko bus declare kar rhe hai define nhi kar rhe aur isko define karne ki zimmedari child class ki hogi => SportsCar joki basically isko extend karega ya inherit karege
...
// $. hume ek child class banani padhegi joki is abstarct method ko declare karti hai 
...
// Main Method => 5> humme janane ki jarurat hi nhi ye methods k andar kya hai in fn ko band kardo bus 

int main() {

    Car* myCar = new SportsCar("Ford", "Mustang"); // parent class ka ek ptr child class k ptr ko pt. kar sakta hai 
