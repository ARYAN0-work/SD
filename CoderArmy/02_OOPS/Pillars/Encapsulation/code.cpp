...
//1. jitne class k behaviours & characters hai it should be enscaptulated SportsCar and its representing a car 

//2. Data security honi chaiye 
...
int main() {
    ...
    // cout << "Current Speed of My Sports Car is set to " << mySportsCar->currentSpeed << endl;// ye possible nhi hona chaiye but print karega ye na ho islye change publuc to private class in 26  ; saare characters private and behaviours public now ab 113 me error aayega kyuki ye provate hai toh now isko change karne ka koi tarika nhi hai so thats why we use concept of getter and setter

    cout << "Current Speed of My Sports Car is " << mySportsCar->getSpeed() << endl;// getter and setter 
